...
public abstract class FormPadrao extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        //======== jpnFormulario ========
        {
            jpnFormulario. addPropertyChangeListener (new java. beans. PropertyChangeListener( ){ @Override public void propertyChange (java .
            ...
            jpnFormularioLayout.setVerticalGroup(
                jpnFormularioLayout.createParallelGroup()
                    .addGroup(jpnFormularioLayout.createSequentialGroup()
                        ...
                        .addGap(57, 57, 57)
                        .addGroup(jpnFormularioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
